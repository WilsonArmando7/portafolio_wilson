    ...
    return (
        <section id="projects" className="p-8 bg-white text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Proyecto 1 */}
                <div className="p-4 border rounded-lg shadow-md p-4 transform transition duration-300 hover:scale-105 hover:-translate-y-1">
                    <Image src="/images/project1.jpg" alt="Proyecto 1" width={300} height={200} className="mb-4" />
                ...
                {/* Proyecto 2 */}
                <div className="p-4 border rounded-lg shadow-md p-4 transform transition duration-300 hover:scale-105 hover:-translate-y-1">
                    <Image src="/images/project1.jpg" alt="Proyecto 2" width={300} height={200} className="mb-4" />
                ...
                {/* Proyecto 3 */}
                <div className="p-4 border rounded-lg shadow-md transform transition duration-300 hover:scale-105 hover:-translate-y-1">
                    <Image src="/images/porta.png" alt="Proyecto 3" width={300} height={200} className="mb-4" />
                ...
                {/* Proyecto 4 */}
                <div className="p-4 border rounded-lg shadow-md  transform transition duration-300 hover:scale-105 hover:-translate-y-1">
                    <Image src="/images/wilso.png" alt="Proyecto 4" width={300} height={200} className="mb-4" />

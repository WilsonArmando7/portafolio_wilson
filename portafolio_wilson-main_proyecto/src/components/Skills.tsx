...
const Skills = () => {
  ...
  return (
    <section id="skills" className="p-8 bg-gray-900 text-white text-center">
      <h2 className="text-2xl font-bold mb-6">Habilidades</h2>
      <p className="mb-8">
        Las habilidades, herramientas y tecnologías en las que soy realmente
        bueno:
      </p>
        ...
        {skills.map((skill) => (
          ...
          >
            <Image
              ...
              height={64}
              className="mb-4"
              priority={true} // Para cargar imágenes prioritarias
            />
